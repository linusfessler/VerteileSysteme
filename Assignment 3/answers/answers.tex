...
The clock ticks happen before the sending of a message. If the tick happened after sending the message, the clock condition would not be fullfilled. Consider the following situation: \includegraphics[scale=0.4]{question3_example}
